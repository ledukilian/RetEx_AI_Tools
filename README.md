...
└── demo_app/
    ├── 0_vanilla_no_design/        # 0️⃣ Version de base "ToDo App"
    ├── 1_composer_version/         # 1️⃣ Générée avec Cursor Composer 2
    ├── 2_claude_sonnet_version/    # 2️⃣ Générée avec Claude Sonnet 4.6
    └── 3_claude_opus_version/      # 3️⃣ Générée avec Claude Opus 4.6
```